...
public class BichburgerItems {
    ...
    public static final RegistryObject<Item> Bich_cola = ITEMS.register("bich_cola", () -> new Item(new Item.Properties().tab(Bichburger_group).food(BichburgerItemFood.Bich_cola).stacksTo(16)));
    public static final RegistryObject<Item> Bich_lemonade = ITEMS.register("bich_lemonade", () -> new Item(new Item.Properties().tab(Bichburger_group).food(BichburgerItemFood.Bich_lemonade).stacksTo(16)));
    public static final RegistryObject<Item> Beer_shrimp = ITEMS.register("beer_shrimp", () -> new Item(new Item.Properties().tab(Bichburger_group).food(BichburgerItemFood.Beer_shrimp).stacksTo(16)));
